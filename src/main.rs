...
struct Cli {
    #[arg(short = 'n', long = "numbers", help= "number of characters", default_value_t = 12)]
    characters: u8,
    #[arg(short = 'x', long = "complex", help= "add special characters", default_value_t = false)]
    complex: bool,
    #[arg(short = 'c', long = "copy", help= "copy to clipboard", default_value_t = false)]
    copy: bool
}
